...
// ORIGINAL ACCOUNT MAPPING - CLEANED UP FOR FULL NAMES
const ACCOUNTS = {
...
export default function App() {
  ...
  if (loading) return <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ff4d6d', fontWeight: '900', fontSize: '18px' }}>🌷 따뜻한 공간으로 이동 중...</div>
